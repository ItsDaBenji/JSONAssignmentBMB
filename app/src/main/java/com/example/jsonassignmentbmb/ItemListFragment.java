...
import com.example.jsonassignmentbmb.databinding.FragmentItemListBinding;
import com.example.jsonassignmentbmb.databinding.ItemListContentBinding;

import com.example.jsonassignmentbmb.placeholder.PlaceholderContent;
...
public class ItemListFragment extends Fragment {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).getRating().toString());
